...
website:
  title: "Poznań Rental Market Analysis"
  description: "Analysis of rental market trends in Poznań - May 2025"
  author: "Jakub Marciniak"
  navbar:
    title: "Poznań Rental Analysis"
    left:
      - href: index.qmd
        text: "Report"
    right:
      - icon: github
        href: https://github.com/yourusername/poznan-rental-analysis  # Update with your repo URL
  page-footer:
    center: "© 2025 Jakub Marciniak | Business Intelligence Developer"
...
format:
  html:
    ...
    fig-width: 10
    fig-height: 6.5
    embed-resources: false  # Changed for better web performance
    page-layout: full
    css: |
      /* Keep TOC sidebar, reduce margins, scale figures 30% smaller */
      ...
      /* Scale figures 30% smaller while keeping quality */
      .cell-output-display {
